...
%\usepackage{tabularx}
\usepackage{dirtree} % for the attachments docs
...
\def\NazevPrace{Plánování dráhy pro rychle se pohybující automobily}
...
\def\Vedouci{prof. RNDr. Roman Barták, Ph.D.}
...
\def\StudijniObor{Umělá inteligence}
...
\include{chapters/autonomous_driving_background}
\include{chapters/racing_agent}
\include{chapters/trajectory_planning}
...
\include{appendixes/hardware}
\include{appendixes/programmer_documentation}
