...
int main(int argc, char *argv[])
{
  ...
  while (ros::ok())
  {
    if (racing_line && last_known_state)
    {
      ...
      ackermann_pub.publish(racer_ros::ackermann_msg_from_angle_and_speed(angle, speed));
      twist_pub.publish(racer_ros::twist_msg_from_angle_and_speed(angle, speed, model));
