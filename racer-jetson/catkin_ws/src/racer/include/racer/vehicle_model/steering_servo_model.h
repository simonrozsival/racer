...
public:
  steering_servo_model(racer::math::angle max_steering_angle_left, racer::math::angle max_steering_angle_right,
      ...
      : max_steering_angle_left_{max_steering_angle_left}, max_steering_angle_right_{max_steering_angle_right}, angle_to_pwm_{angle_to_pwm}, pwm_adjustment_coefficients_{pwm_adjustment_coefficients}
  {
  }
  ...
  {
    return std::make_unique<steering_servo_model>(angle::from_degrees(-20), angle::from_degrees(20),
                                                  std::array<double, 2>{12.701, 1476.686},
                                                  std::array<double, 2>{0.000329, 0.1174});
  }
