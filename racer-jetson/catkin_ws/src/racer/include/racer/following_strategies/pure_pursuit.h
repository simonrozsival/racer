...
{
public:
  pure_pursuit(double wheelbase, double min_lookahead, double max_lookahead, double max_rpm)
  ...
  racer::vehicle_configuration find_target(const State &state, int passed_waypoints,
